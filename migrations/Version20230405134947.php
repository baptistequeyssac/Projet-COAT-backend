 ...
 */
final class Version20230405134947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist ADD region_id INT NOT NULL, DROP region');
        ...
        $this->addSql('ALTER TABLE event ADD region_id INT NOT NULL, DROP region');
        ...
        $this->addSql('ALTER TABLE organizer ADD status_id INT NOT NULL, ADD region_id INT NOT NULL, DROP region');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD region VARCHAR(128) NOT NULL, DROP region_id');
        $this->addSql('DROP INDEX IDX_159968798260155 ON artist');
        $this->addSql('ALTER TABLE artist ADD region VARCHAR(128) NOT NULL, DROP region_id');
        $this->addSql('DROP INDEX IDX_99D471736BF700BD ON organizer');
        $this->addSql('DROP INDEX IDX_99D4717398260155 ON organizer');
        $this->addSql('ALTER TABLE organizer ADD region VARCHAR(128) NOT NULL, DROP status_id, DROP region_id');
    }
}
